...
def fuck():
    ...
    print(' [+] OK Ids saved in HAMIDUL/OK.txt')
    print(' [+] CP Ids saved in HAMIDUL/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[HAMIDUL]--[%s/%s]--[CP%s]~[OK-%s] \r'%(loop,tl,len(cps),len(oks))),
            sys.stdout.flush()
